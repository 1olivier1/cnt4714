...
<body>
    ...
    <p>You are connected to the Project 4 Enterprise System Database as a <span style="color: red;">CLIENT-LEVEL</span> user.<br> please enter valid sql commands</p>
    <form action="clientSql" method="post">
        <label for="sqlCommand">Enter SQL Command:</label><br>
        <textarea id="sqlCommand" name="sqlCommand" rows="4" cols="50"></textarea><br><br>
